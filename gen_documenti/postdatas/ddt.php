...
if ($insert["azione"] === "modifica") {
    ...
    if ($stampa == "ddt") {
        $sql = "INSERT INTO stampa_" . $stampa . " 
            (id, peso, data_doc, mezzo, cliente, Piva, indirizzo, citta, causale, n_colli, arr_qta, arr_beni, note, imballo, data_consegna, data_rit, vettore, arr_imp_uni) values
            ('" . $doc_n . "','" . $insert["peso"] . "','" . $insert["data"] . "','" . $insert["mezzo"] . "','" . $insert["cliente"] . "','" . $insert["piva"] . "','" . $insert["indirizzo"] . "','" . $insert["citta"] . "','" . $insert["causale"] . "','" . $insert["colli"] . "','" . $insert["quantita"] . "','" . $insert["articoli"] . "','" . $insert["nota"] . "', '" . $insert["aspettoBeni"] . "','" . $insert["consegnaData"] . "','" . $insert["ritiroData"] . "', '" . $insert["vettore"] . "', '" . $insert["prezzi"] . "')";
        //echo $sql;
    }
