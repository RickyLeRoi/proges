...
--
-- Host: localhost
-- Generato il: Giu 20, 2016 alle 08:54
...
(1, 'Daniele', 'Irsuti', '001C1', 'via daniele', 'Danielopoli', 90100, 'PA', '091234567', '091234567', 'Italia', 'daniele@email.it', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Letto', 'Danielo', NULL, '2016-06-06 07:40:36'),
(2, 'Riccardo', 'Giordano', '002C2', 'via riccardo', 'Riccardopoli', 90100, 'PA', '091456789', '091456789', 'Italia', 'riccardo@email.it', 'riccardogiordano.space', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'GRDRCR00A00G273A', 'IT3A89151651615615615615566', 'UniCredit Filiale Ficarazzi', 'Riccardo', NULL, '2016-06-06 07:40:36'),
(3, 'nome', 'cognome', '003C3', 'indirizzo', 'citta''', 12345, 'PR', '091408509', '12315151', 'stato', 'email@email.dom', 'urldimunch.it', 'indirizzo', 'citta''', 12345, 'PR', '12315151', '2147483647', 'stato', 'email@email.dom', 'urldimunch.it', 2147483647, 'fefrgreg45654tgr', '235235235345435435', 'banca', 'descrizione', 'note', '2016-06-06 07:40:36');
...
(1, 'Fornitore', 'Di Prova', '001F1', 'via del fornitore', 'Sua CittÃ ', 12345, 'PR', '+39091123456', '+39091123456', 'Italia', 'suaemail@dom.it', 'url.web.dominio', 2147483647, 'CFFCCF55C155C151', '', 'Banca sua - Palermo', 'descrizione', NULL, '2016-06-06 07:41:43');
...
(1, '0000-00-00', 'destinatario', 'Riccardo Giordano', '', 'GRDRCR00A00G273A', 'via riccardo', 'Riccardopoli', 'PA', '90010', 'conto vendita', 'aspetto proprio', 2, 5, '0000-00-00', '125||100', 'etichette sardine 10000pz||etichette sardine 20000pz', '120x30 mm||120x30 mm', '', '');
...
(1, '0000-00-00', '30 giorni data fattura', 'Riccardo Giordano', '', 'GRDRCR00A00G273A', 'via riccardo', 'Riccardopoli', 'PA', '90010', '125||100', 'etichette sardine 10000pz||etichette sardine 20000pz', '120x30 mm||120x30 mm', '2||2', '250||200', 450, 10, 495, 0, '0000-00-00', '0000-00-00');
...
(1, '0000-00-00', '30 giorni data fattura', 'Riccardo Giordano', '', 'GRDRCR00A00G273A', 'via riccardo', 'Riccardopoli', 'PA', '90010', '125||100', 'etichette sardine 10000pz||etichette sardine 20000pz', '120x30 mm||120x30 mm', '2||2', '250||200', 450, 10, 495);
